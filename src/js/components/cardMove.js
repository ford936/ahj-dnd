export default class CardMove {
  ...
  moveCard(e) {
    ...
    if (elemBelow.classList.contains('card')) {
      ...
      const middleYCoordElemBelow = elemBelowRect.bottom - (elemBelowRect.bottom - elemBelowRect.top) / 2;
      const middleYCoordActualElement = actualElementRect.bottom
  ...
  selectCard(e) {
    ...
    this.emptyPlace.style.height = `${this.actualElement.getBoundingClientRect().height}px`;
    this.emptyPlace.style.width = `${this.actualElement.getBoundingClientRect().width}px`;
